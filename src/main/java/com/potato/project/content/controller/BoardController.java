...
public class BoardController {
	...
	//공지사항 페이지로 이동
	@GetMapping("/notice")
	public String goNotice(Model model, String menuCode, HttpSession session) {
	...
	//상담 문의 페이지로 이동
	@GetMapping("/qna")
	public String goQna(Model model, String menuCode, HttpSession session) {
		MemberVO loginInfo = (MemberVO)session.getAttribute("loginInfo");
	...
	//상담 문의 등록으로 이동
	@GetMapping("/qnaForm")
	public String goQnaForm(Model model, String menuCode, HttpSession session) {
		MemberVO loginInfo = (MemberVO)session.getAttribute("loginInfo");
