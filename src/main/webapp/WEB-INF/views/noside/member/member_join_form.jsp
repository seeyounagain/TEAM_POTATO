...
<script type="text/javascript" src="/resources/member/js/member_join_form.js?ver=1" ></script>
</head>
<body>
	...
	<div class="row g-0 justify-content-center">
		...
		<hr>
			...
			<label for="gender" class="form-label">관심 카테고리</label>
				<div class="col-12 mt-1">
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="checkbox" name="favorite" value="option1">
