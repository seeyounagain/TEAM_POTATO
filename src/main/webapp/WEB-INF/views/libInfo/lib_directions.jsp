	...
	<div>
		...
		<div class="busTableDiv1">
			<table class="table text-center">
				...
				<tbody>
					...
					<tr>
						<td rowspan="5">시외버스터미널<br>(도보 12분)</td>
						<td>246</td>
					...
					<tr>
						<td rowspan="3">고속버스터미널<br>(도보15분)</td>
						<td>910(지선)</td>
		...
		<div class="busTableDiv2">
			<table class="table text-center">
				...
				<tbody>
					<tr>
						<td rowspan="10">농수산물도매시장<br>(도보 15분)</td>
						<td>신복로터리</td>
		...
		<div>※ 환승안내 : 공업탑, 시청, 학성공원 등에 하차 후 울산도서관 정류소 경유 시내버스로 환승가능</div>
