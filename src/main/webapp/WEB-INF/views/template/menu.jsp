	...
	<div class="col-12 pb-2">
		...
		<c:forEach var="menu" items="${menuList }">
			<li class="nav-item">
				...
				<a class="dropdown-toggle title" <c:if test ="${menu.menuAuto eq '1'}">href="/${menu.menuUri }/${menu.menuUri }?menuCode=${menu.menuCode }"</c:if> <c:if test="${menu.menuAuto ne '1'}">id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"</c:if>>${menu.menuName}</a>
